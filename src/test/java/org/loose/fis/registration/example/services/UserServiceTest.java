...
public class UserServiceTest extends TestCase {
    ...
    public void testAddOneUser() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test", "testPass", "432","Thomas Jefferson","0770192192");
        assertNotNull(UserService.users);
    ...
    public void testAddTwoUsers() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test1", "testPass1", "123","Thomas Jefferson","0770192192");
        UserService.addUser("test2", "testPass2", "456","Thomas Jefferson","0770192192");
        assertNotNull(UserService.users);
    ...
    public void testAddTwoUserArePersisted() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test1", "testPass1", "123","Thomas Jefferson","0770192192");
        UserService.addUser("test2", "testPass2", "432","Thomas Jefferson","0770192192");
        List<User> users = new ObjectMapper().readValue(UserService.USERS_PATH.toFile(), new TypeReference<List<User>>() {
        });
        assertNotNull(users);
